...
import sistema.os.API.Controller.ProdutosController;
...
public class ProdutoRoutes {
    ...
    public ProdutoRoutes() {
        ...
        this.controller = new ProdutosController(criarUseCase, buscarUseCase, listarUseCase, editarUseCase, deletarUseCase);
    }
    ...
    public void register(Javalin app) {
        ...
        app.post("/api/produtos", ctx -> {
            try {
                System.out.println("[PRODUTOS] Criando novo produto...");
                CriarProdutoRequest request = ctx.bodyAsClass(CriarProdutoRequest.class);
                System.out.println("[PRODUTOS] Request recebido: " + request.nome());
                var response = controller.criar(request);
                System.out.println("[PRODUTOS] Produto criado com sucesso!");
